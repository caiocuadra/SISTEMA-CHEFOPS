...
class Pedido
{
    ...
    {
        try {
            $sql = MySql::conectar()->prepare("INSERT INTO `pedidos` (id, insumo, quantidade, dia, mes, dataDiaMes, nome_loja) VALUES (null, ?, ?, ?, ?, ?, ?)");
    ...
    public function reconhecerInsumosParaPedido()
    {
